...
function AccordionGroup(props: ComponentProps<typeof Accordions>) {
  return <Accordions type="single" collapsible {...props} />;
}
...
function Tabs({ children }: { children: ReactNode }) {
  ...
  const tabs = items.map((child, index) => {
    const props = child.props as { title?: ReactNode; value?: string };
