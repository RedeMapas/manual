...
title: Themes
---
> Create and customize installation themes: directory layout, asset enqueueing, template parts, view inheritance, and RedeMapas-specific features.
...
The old developer guide highlighted one operational detail that is still easy to miss: changes to the active theme often need to be validated together with deployment config, authentication UI, and PWA / Web Push behavior, because the theme is where those installation-specific concerns meet.

When auditing a UI or login issue, always confirm whether the behavior comes from:
