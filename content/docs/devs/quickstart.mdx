...
* [Docker Compose](/docs/devs/deploy/docker) para HTTPS com Caddy, shell dentro do contêiner, PsySH, acesso ao PostgreSQL, restauração e rebuild de assets
* [Testes](/docs/devs/development/testing) para uso do PHPUnit, estrutura de testes, builders e directors
* [Arquitetura](/docs/devs/development/architecture) para stack, fluxo de execução e organização do workspace
