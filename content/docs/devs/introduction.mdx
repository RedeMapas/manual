...
Para ver a stack completa, a organização de diretórios, os fluxos de execução e as abstrações centrais, consulte o guia canônico de [Arquitetura](/mnt/data/code/redemapas/manual/content/docs/devs/development/architecture.mdx).
...
* use [Início Rápido](/mnt/data/code/redemapas/manual/content/docs/devs/quickstart.mdx) para setup local e checagens da primeira execução
* use [Arquitetura](/mnt/data/code/redemapas/manual/content/docs/devs/development/architecture.mdx) para stack, fluxo de requisição e abstrações centrais
* use [Docker Compose](/mnt/data/code/redemapas/manual/content/docs/devs/deploy/docker.mdx) para operações com contêineres e HTTPS local
* use [Testes](/mnt/data/code/redemapas/manual/content/docs/devs/development/testing.mdx) para o fluxo com PHPUnit
